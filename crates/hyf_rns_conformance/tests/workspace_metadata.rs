...
const REQUIRED_PUBLIC_DOCS: &[PublicDocSpec] = &[
    ...
    PublicDocSpec {
        path: "docs/architecture/fips_sidecar.md",
        required: &[
            ...
            "FipsNodeAddr",
            "control_json",
            "does not implement a live FIPS daemon",
        ],
        forbidden: PUBLIC_REPO_FORBIDDEN_SNIPPETS,
    },
    PublicDocSpec {
        path: "docs/integrations/fips.md",
        required: &[
            "FIPS Sidecar Carrier",
            "hyf_link_fips",
            "FakeFipsSidecar",
            "FipsGatewayExecutor",
            "not a live FIPS runtime",
            "No external FIPS crate",
        ],
        forbidden: PUBLIC_REPO_FORBIDDEN_SNIPPETS,
    },
    PublicDocSpec {
        path: "docs/verification/fips_sidecar.md",
        required: &[
            ...
            "no default check requires",
            "live FIPS daemon",
        ],
        forbidden: PUBLIC_REPO_FORBIDDEN_SNIPPETS,
    },
    PublicDocSpec {
        path: "docs/adr/0004-fips-gateway-sidecar-integration.md",
        required: &["Accepted", "ADR 0011", "gateway-side carrier surface"],
        forbidden: PUBLIC_REPO_FORBIDDEN_SNIPPETS,
    },
    PublicDocSpec {
        path: "docs/adr/0011-fips-fake-sidecar-carrier.md",
        required: &["Accepted", "FakeFipsSidecar", "GatewayLinkExecutor"],
        forbidden: PUBLIC_REPO_FORBIDDEN_SNIPPETS,
    },
    PublicDocSpec {
        path: "docs/adr/0012-fips-identity-addressing.md",
        required: &[
            "Accepted",
    ...
    PublicDocSpec {
        path: "docs/adr/0013-no-fips-runtime-dependency.md",
        required: &[
            "Accepted",
            "No FIPS Runtime Dependency",
            "Do not add a live FIPS daemon dependency",
        ],
        forbidden: PUBLIC_REPO_FORBIDDEN_SNIPPETS,
    },
    PublicDocSpec {
